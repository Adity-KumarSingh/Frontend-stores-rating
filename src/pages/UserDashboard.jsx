...
const UserDashboard = () => {
  ...
  const fetchStores = async () => {
    try {
      const unratedRes = await axios.get(`http://localhost:5000/api/stores/unrated/${userId}`);
      const ratedRes = await axios.get(`http://localhost:5000/api/stores/rated/${userId}`);
